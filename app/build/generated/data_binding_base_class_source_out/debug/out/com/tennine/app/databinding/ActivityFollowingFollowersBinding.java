...
public final class ActivityFollowingFollowersBinding implements ViewBinding {
  ...
  private ActivityFollowingFollowersBinding(@NonNull LinearLayoutCompat rootView,
  ...
  @NonNull
  public static ActivityFollowingFollowersBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityFollowingFollowersBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_following_followers, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityFollowingFollowersBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityFollowingFollowersBinding((LinearLayoutCompat) rootView, ivBack,
