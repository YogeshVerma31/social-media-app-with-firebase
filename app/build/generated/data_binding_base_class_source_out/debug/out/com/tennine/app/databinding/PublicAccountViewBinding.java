...
public final class PublicAccountViewBinding implements ViewBinding {
  @NonNull
  ...
  private PublicAccountViewBinding(@NonNull ConstraintLayout rootView,
      @NonNull Button btnEditProfile, @NonNull ImageView btnPost, @NonNull ImageView btnReels,
      @NonNull Button button10, @NonNull CardView cardView, @NonNull CardView cvFollowers,
      @NonNull ImageView imageView23, @NonNull ImageView imageView24,
      @NonNull ImageView imageView25, @NonNull ImageView imageView28,
      @NonNull RoundedImageView ivPost, @NonNull TextView textView68, @NonNull TextView textView70,
      @NonNull TextView textView73, @NonNull TextView tvFollowers, @NonNull TextView tvFollowing,
      @NonNull TextView tvFullName, @NonNull TextView tvNickName, @NonNull TextView tvPost,
  ...
  @NonNull
  public static PublicAccountViewBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static PublicAccountViewBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.public_account_view, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static PublicAccountViewBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new PublicAccountViewBinding((ConstraintLayout) rootView, btnEditProfile, btnPost,
          btnReels, button10, cardView, cvFollowers, imageView23, imageView24, imageView25,
          imageView28, ivPost, textView68, textView70, textView73, tvFollowers, tvFollowing,
