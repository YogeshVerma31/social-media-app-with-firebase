...
import com.tennine.app.activity.ui.FriendsActivity;
...
public class FollowersFragment extends Fragment implements OnClickListener {
    ...
    private void setDataToRV() {
        ...
        followersAdapter = new FollowersAdapter(followingFollowersModelList,this);
    ...
    private void checkUserExists(DocumentSnapshot documentSnapshot,FriendListener listener) {
        firebaseFirestore.collection("users")
                .document(preferenceManager.getString("id")).collection("FOLLOWING")
